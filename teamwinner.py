...
rf_model = joblib.load('best_random_forest_model.pkl')  # Load the Random Forest model
ct = joblib.load('column_transformer.pkl')


# # Define the date range for the match dates
# start_date = datetime(2003, 1, 1)
# end_date = datetime(2023, 9 , 9)
# # Generate a random match date
# match_date = random.choice(start_date(), end_date())
